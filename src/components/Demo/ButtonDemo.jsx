...
/* ─────────────────────────────────────────────
   Live Preview Safe Showcase
───────────────────────────────────────────── */
export default function BorderGlowButtonsPreview() {
  const themeCtx = useContext(ThemeContext);
  const isDarkMode = themeCtx?.isDarkMode ?? true;

  return (
    <div className="flex min-h-[420px] w-full flex-col items-center justify-center overflow-hidden bg-transparent px-4 py-8 font-sans sm:px-6 sm:py-10">
      <div className="mb-8 max-w-2xl text-center">
        <p className="mb-3 text-[11px] font-semibold uppercase tracking-[0.22em] text-brand-accent">
          Border Glow Buttons
        </p>

        <h2 className="text-[clamp(2rem,6vw,4rem)] font-semibold leading-[0.95] tracking-[-0.055em] text-brand-text">
          Glow buttons.
        </h2>
      ...
      <div className="grid w-full max-w-3xl grid-cols-1 place-items-center gap-5 sm:grid-cols-2 lg:grid-cols-3">
        <NtaButton
          text="System Access"
          animated
